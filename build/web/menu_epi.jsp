<%-- 
    Document   : menu_epi
    Created on : 8/06/2021, 01:16:55 PM
...
<%
    ...
    <%
        ...
        cur = con_cur.Datos_curso("EPILEPSIA", 5);
    ...
    <table class="tabla">
        <tr>
            <td>
                ...
                <p class="subtitulo">
                    Aprende a ayudar a una persona que se este sufriendo de un ataque de 
                    epilecia.
                </p>
                <br>
                <%
                    if(bandera){
                        %>
                        <a href="mod1_epi.jsp" class="boton">Continuar Curso</a>
                <%
                    }else{
                        %>
                         <a href="Modulo_Epilepsia" class="boton">Comenzar Curso</a>
                        <%
                    }
            ...
            <td>
                <img class="rcp" src="IMG/curso_epilepcia.png">
            </td>
        </tr>
    </table>
    <br>
    ...
    <table class="tabla">
        <tr>
            <td class="parte1">
                ...
                <p class="parrafo">
                    Con este curso gratuito aprenderás a como ayudar a una persona que este sufriendo de un 
                    ataque de epilepcia. Aunque no lo creas son muy comunes y saber como actuar ante 
                    esta emergencia es muy importnate.  Aprenderás lo suficiente para salvarle la vida 
                    a alguien.
                </p>
            </td>
            <td>
                <ul class="lista2">
                    ...
                    <li>
                        <i class="fas fa-check-circle fa-1.5x"></i>
                        Aprende a detener (no al 100%) un ataque de epilepcia
                    </li>
                    <br>
                    <li>
                        <i class="fas fa-check-circle fa-1.5x"></i>
            ...
            <tr>
                ...
                <td>
                    <div class="caja">
                        ...
                        <br>
                        <br>
                        <center><p class="decaja">¿Qués es? - Causas</p></center>
                    </div>
                </td>
                <td>
                    <div class="caja">
