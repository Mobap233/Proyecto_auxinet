<%-- 
    Document   : menu_asf
    Created on : 8/06/2021, 12:01:30 AM
...
<%
    ...
    <%
        ...
        cur = con_cur.Datos_curso("ASFIXIA", 5);
    ...
    <table class="tabla">
        <tr>
            <td>
                ...
                <p class="subtitulo">
                    Aprende a ayudar y a reanimar a una persona que este sufriendo una asfixia.
                </p>
                <br>
                <%
                    if(bandera){
                        %>
                        <a href="mod1_asf.jsp" class="boton">Continuar Curso</a>
                <%
                    }else{
                        %>
                         <a href="Modulo_Asfixia" class="boton">Comenzar Curso</a>
                        <%
                    }
            ...
            <td>
                <img class="rcp" src="IMG/curso_asfixia.png">
            </td>
        </tr>
    </table>
    <br>
    ...
    <table class="tabla">
        <tr>
            <td class="parte1">
                ...
                <p class="parrafo">
                    Con este curso gratuito aprenderás a como ayudar a una persona que se este
                    ahogando.  Aprenderás lo suficiente para salvarle la vida 
                    a alguien.
                </p>
            </td>
            <td>
